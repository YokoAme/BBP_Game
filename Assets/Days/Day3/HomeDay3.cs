...
public class RoomScene_Day3 : MonoBehaviour
{
    ...
    IEnumerator RunScene()
    {
        ...
        // ---------- запуск диалога ----------
        dialogueManager.StartDialogue("Dialogue_HomeDay3.json");
        ...
        UnityEngine.SceneManagement.SceneManager.LoadScene("IncD3"); // замени на нужную
    }
}
