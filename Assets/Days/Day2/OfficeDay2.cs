...
public class OfficeDay2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            SaveSystem.Instance.Data.currentDay = 2;  // ← поставь нужный день
            Debug.Log("<color=orange>Установлен день вручную для теста: 2</color>");
        }
    ...
    IEnumerator RunDaySequence()
    {
        ...
        dialogueManager.StartDialogue("Dialogue_OfficeDay2.json");

        // 7. Появление босса справа
